...
<title>Raj-Freelancer - Start Bootstrap Theme</title>
<!-- Favicon-->
<link rel="icon" type="image/x-icon" href="assets/download.jpeg" />
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top"> Wellcome <%=session.getAttribute("name")%></a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/ironman.png"
				alt="..." />
			<!-- Masthead Heading-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Backend
				Development - Frontend Development - Oracle Database</p>
		</div>
	</header>
	<!-- Portfolio Section-->
