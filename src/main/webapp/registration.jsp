...
<body>
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="Registartion" class="register-form"
							id="register-form">
							...
							<div class="form-group">
								<label for="pass"><i class="zmdi zmdi-lock"></i></label> <input
									type="password" name="passw" id="pass" placeholder="Password" required="required" />
							</div>
							<div class="form-group">
								<label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
								<input type="password" name="re_passw" id="re_pass"
	...
	<script type="text/javascript">
	   ...
	   if(status=="success")
	   {
		   swal("Congrats","Account Created Successdully","success");
	   }
	   ...
	   {
		   swal("Congrats","Please Enter valid Emailid","error");
	   }
	   ...
	   {
		   swal("Congrats","Mobile Number Should be 10 digit's","error");
	   }
	</script>
